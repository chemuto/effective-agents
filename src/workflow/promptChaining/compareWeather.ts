...
const weatherComparison = await generateText(
  `The current weather in ${city} is ${currentWeather}. Compare it to the average weather in ${city} for this time of year.`
);
console.log("\n\n");
console.log("WeatherComparison: \n", weatherComparison);
